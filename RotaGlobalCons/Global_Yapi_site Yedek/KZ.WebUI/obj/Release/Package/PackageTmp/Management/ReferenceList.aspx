<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="ReferenceList.aspx.cs" Inherits="KZ.WebUI.Management.ReferenceList" %>
                            ...
                            <div class="card alert table-responsive">
                                ...
                                <div class="bootstrap-data-table-panel order-list-item">
                                    ...
                                    <table id="bootstrap-data-table" class="table table-responsive table-bordered">
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="rptReferenceList" runat="server" OnItemCommand="rptReferenceList_OnItemCommand" OnItemDataBound="rptReferenceList_OnItemDataBound">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                            <img src="UploadFiles/Reference_Images/<%#Eval("Image") %>" width="150" />
                                                        </td>
                                                        <td>
                                                            <%# Eval("Title") %>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="ReferenceUpdate-<%#Eval("Id") %>">

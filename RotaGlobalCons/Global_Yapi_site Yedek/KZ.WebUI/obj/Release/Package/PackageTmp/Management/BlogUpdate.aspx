<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="BlogUpdate.aspx.cs" Inherits="KZ.WebUI.Management.BlogUpdate" ValidateRequest="false" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Blog Bilgileri Düzenleme</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <h4>Blog Bilgileri Düzenleme</h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <%--<div class="form-group">
                                            <label>Link</label>
                                            <asp:TextBox runat="server" ID="txtLink" CssClass="form-control" MaxLength="250" onkeypress="return isTextNumber(event);" AutoPostBack="True" OnTextChanged="txtLink_OnTextChanged"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br />
                                            <asp:Literal runat="server" ID="ltlImage"></asp:Literal><asp:LinkButton runat="server" ID="lnkImageDelete" OnClick="lnkImageDelete_OnClick" OnClientClick="return window.confirm('Silmek istediğinize eminmisiniz ?');">&nbsp;(<i class="fa fa-trash"></i> Kaldır)</asp:LinkButton>

<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="ExternalArticleUpdate.aspx.cs" Inherits="KZ.WebUI.Management.ExternalArticleUpdate" ValidateRequest="false" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="#">Bağımsız Yazı Yönetim</a></li>
                                    <li class="active">Bağımsız Yazı Bilgileri Düzenleme</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <h4>Bağımsız Yazı Bilgileri Düzenleme</h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group">
                                            <label>Link</label>
                                            <asp:TextBox runat="server" ID="txtLink" CssClass="form-control" onkeypress="return isTextNumber(event);" MaxLength="250" AutoPostBack="True" OnTextChanged="txtLink_OnTextChanged"></asp:TextBox>

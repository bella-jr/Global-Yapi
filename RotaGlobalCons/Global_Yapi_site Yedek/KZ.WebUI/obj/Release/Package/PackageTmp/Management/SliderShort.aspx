<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="SliderShort.aspx.cs" Inherits="KZ.WebUI.Management.SliderShort" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Slider Sıralama</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <h4>Slider Sıralama</h4>
                                </div>
                                <div class="card-body">
                                    <div id="mainMenuOrder">
                                        <ul>
                                            <asp:Repeater runat="server" ID="rptSliderList">
                                                <ItemTemplate>
            ...
            $(function () {
                $("#mainMenuOrder ul").sortable({
                    ...
                    update: function () {
                        ...
                        $.post("ShortSavePages/SliderShortSave.aspx", order);
                    }
                });
            });
        });

<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="ExternalArticleAdd.aspx.cs" Inherits="KZ.WebUI.Management.ExternalArticleAdd" ValidateRequest="false" %>
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <asp:Panel ID="pnlContent" runat="server" CssClass="basic-form">
                                        ...
                                        <div class="form-group">
                                            <label>Başlık</label>
                                            <asp:TextBox runat="server" ID="txtTitle" ClientIDMode="Static" CssClass="form-control" MaxLength="150" onkeypress="return isTextNumber(event);" AutoPostBack="True" OnTextChanged="txtTitle_OnTextChanged" onkeyup="setSeoTitle(this.value);"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            <label>Link</label>
                                            <asp:TextBox runat="server" ID="txtLink" CssClass="form-control" onkeypress="return isTextNumber(event);" MaxLength="250" Enabled="False" AutoPostBack="True" OnTextChanged="txtLink_OnTextChanged"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            <b>Google Index Alsın :&nbsp;</b><br />
                                            <asp:CheckBox runat="server" ID="cbGoogleIndex" Checked="True" Text="Evet / Hayır" />
                                        </div>
                                        <div class="form-group">

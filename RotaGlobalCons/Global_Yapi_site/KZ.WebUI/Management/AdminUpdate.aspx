<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="AdminUpdate.aspx.cs" Inherits="KZ.WebUI.Management.AdminUpdate" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Admin Bilgileri Güncelleme</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <h4>Admin Bilgileri Güncelleme</h4>
                                </div>
                                <div class="card-body">

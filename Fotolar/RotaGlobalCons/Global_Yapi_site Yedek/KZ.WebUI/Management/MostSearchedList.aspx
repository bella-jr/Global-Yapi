<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="MostSearchedList.aspx.cs" Inherits="KZ.WebUI.Management.MostSearchedList" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Çok Arananları Listele</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card alert table-responsive">
                                ...
                                <div class="bootstrap-data-table-panel order-list-item">
                                    ...
                                    <table id="bootstrap-data-table" class="table table-responsive table-bordered">
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="rptMostSearchedList" runat="server" OnItemCommand="rptMostSearchedList_OnItemCommand" OnItemDataBound="rptMostSearchedList_OnItemDataBound">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td><%#Eval("Title") %></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="MostSearchedUpdate-<%#Eval("Id") %>">

<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="CommentList.aspx.cs" Inherits="KZ.WebUI.Management.CommentList" %>
                            ...
                            <div class="card alert table-responsive">
                                ...
                                <div class="bootstrap-data-table-panel order-list-item">
                                    ...
                                    <table id="bootstrap-data-table" class="table table-responsive table-bordered">
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="rptCommentList" runat="server" OnItemCommand="rptCommentList_OnItemCommand" OnItemDataBound="rptCommentList_OnItemDataBound">
                                                <ItemTemplate>
                                                    <tr>

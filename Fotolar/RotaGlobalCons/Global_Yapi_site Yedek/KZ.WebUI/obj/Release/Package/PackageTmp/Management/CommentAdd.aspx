<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="CommentAdd.aspx.cs" Inherits="KZ.WebUI.Management.CommentAdd" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Yeni Yorum Ekle</li>
                                </ol>
                            </div>
                        </div>
                    </div>

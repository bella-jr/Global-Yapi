<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="MenuList.aspx.cs" Inherits="KZ.WebUI.Management.MenuList" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Menü Bilgileri Düzenle & Sil</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <h4>Menü Bilgileri Düzenle & Sil</h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Düzenlenecek Menü</label>
                                        <asp:DropDownList runat="server" ID="ddlMenuList1" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlMenuList1_OnSelectedIndexChanged" />
                                    </div>

                                    <asp:Panel runat="server" ID="pnlUpdateContent" CssClass="basic-form" Enabled="False">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlMenuList2" CssClass="form-control" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <%--<div class="form-group">
                                            Üst Kısımda Göster:&nbsp;<br />
                                            <asp:CheckBox runat="server" ID="cbIsHeader" Checked="False" Text="Evet / Hayır" />
                                        </div>--%>
                                        <%-- <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <asp:Button runat="server" ID="btnDelete" Text="Sil" CssClass="btn btn-danger btn-lg" OnClick="btnDelete_OnClick" OnClientClick="return window.confirm('Silmek istediğinize eminmisiniz ?');" />
                                    </asp:Panel>
                                </div>
                            </div>
                        </div>

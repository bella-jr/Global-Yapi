<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="CommentUpdate.aspx.cs" Inherits="KZ.WebUI.Management.CommentUpdate" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="#">Yorum Yönetim</a></li>
                                    <li class="active">Yorum Bilgileri Düzenleme</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header">
                                    <img src="assets/images/menu_icons/comment.png" />&nbsp;
                                    <h4>Yorum Bilgileri Düzenleme</h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <div class="form-group">
                                            <label>Ad</label>
                                            <asp:TextBox runat="server" ID="txtName" ClientIDMode="Static" CssClass="form-control" MaxLength="150"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            <label>Soyad</label>
                                            <asp:TextBox runat="server" ID="txtSurname" ClientIDMode="Static" CssClass="form-control" MaxLength="150"></asp:TextBox>

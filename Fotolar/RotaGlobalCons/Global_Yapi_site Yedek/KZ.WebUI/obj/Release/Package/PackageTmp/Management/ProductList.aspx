<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="KZ.WebUI.Management.ProductList" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Proje Listele</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card alert table-responsive">
                                ...
                                <div class="bootstrap-data-table-panel order-list-item">
                                    ...
                                    <table id="bootstrap-data-table" class="table table-responsive table-bordered">
                                        ...
                                        <tbody>
                                            <asp:Repeater ID="rptProductList" runat="server" OnItemCommand="rptProductList_OnItemCommand" OnItemDataBound="rptProductList_OnItemDataBound">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td>
                                                            <a data-fancybox="images" href="UploadFiles/Product_Images/Big_<%#Eval("Image") %>">
                                                                <img src="UploadFiles/Product_Images/Small_<%#Eval("Image") %>" width="50" /></a>
                                                        </td>
                                                        <td><a target="_blank" href="/<%= Resources.value.url_Folder %><%= Resources.value.url_Urun %>/<%# Tools.UrlSeo(Eval("Title").ToString()) %>-<%# Eval("Id") %>"><%#Eval("Title") %></a></td>
                                                        <td>

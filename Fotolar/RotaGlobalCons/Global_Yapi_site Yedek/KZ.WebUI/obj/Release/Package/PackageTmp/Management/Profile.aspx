<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="KZ.WebUI.Management.Profile" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="#">Profil Yönetim</a></li>
                                    <li class="active">Profil Bilgileri Güncelleme</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card alert">
                                <div class="card-header">
                                    ...
                                    <h4>Profil Bilgileri Güncelleme</h4>
                                </div>
                                <div class="card-body">

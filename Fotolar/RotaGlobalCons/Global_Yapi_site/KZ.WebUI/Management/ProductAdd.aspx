<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="ProductAdd.aspx.cs" Inherits="KZ.WebUI.Management.ProductAdd" %>
                ...
                <div class="main-content">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="tab1">
                                                <div class="basic-form">
                                                    ...
                                                    <%--<div class="form-group">
                                                        <label>Fiyat</label>
                                                        <asp:TextBox runat="server" ID="txtPrice" CssClass="form-control" onkeypress="return isPrice(event);" Text="0"></asp:TextBox>
                                                    </div>--%>
                                                    <%-- <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:Button runat="server" ID="btnCompleted" Text="Tamamla ve Kaydet" CssClass="btn btn-warning btn-lg pull-left" OnClick="btnCompleted_OnClick" CausesValidation="False" Visible="False" />
                        </div>
                    </div>

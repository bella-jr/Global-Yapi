<%@ Page Language="C#" MasterPageFile="~/Management/MP.Master" AutoEventWireup="true" CodeBehind="GalleryAdd.aspx.cs" Inherits="KZ.WebUI.Management.GalleryAdd" %>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Yeni Galeri Ekle</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <asp:Panel ID="pnlContent" runat="server" CssClass="basic-form">
                                       ...
                                       <%-- <div class="row m-b-15">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ErrorMessage="Lütfen fotoğraf seçiniz." ControlToValidate="flpImage"
                                                runat="server" Display="Dynamic" ForeColor="#e74c3c" />
                                        </div>
